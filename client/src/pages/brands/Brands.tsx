      ...
      <div className="flex justify-center items-center flex-col w-full">
        <div className="bg-black shadow-2xl z-10 relative flex justify-between items-center px-[1rem] sm:px-[2rem] flex-col lg:flex-row w-full rounded-2xl py-[1.5rem] sm:py-[4rem] mt-[3.5rem] sm:mt-[5rem]">
          <div className="text-white">
            <h3 className="text-xl sm:text-2xl md:text-4xl kalnia-font">
              <span className="text-2xl sm:text-3xl md:text-6xl bg-gradient-to-br from-cool-pink via-cream to-yellow bg-clip-text text-transparent">INDIAN</span> <br /> Brands to know
            </h3>
